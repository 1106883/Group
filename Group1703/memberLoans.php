...
<div id="wrapper">
    ...
    <div id="page">
        <div id="content">
            ...
            $query = "SELECT loanerID, copyID, Title, start_date, end_date FROM borrow INNER JOIN gamecollection ON borrow.gameID = gamecollection.gameID WHERE borrowerID = ".$_SESSION["username"]." ORDER BY end_date";
            try {
